...
@Component({
  selector: 'app-risk-approbals',
  templateUrl: './risk-approbals.component.html',
  styleUrls: ['./risk-approbals.component.scss']
})
export class RiskApprobalsComponent implements OnInit {
  ...
  callCurrentUserTickets() {
    ...
    this.uApi.callGetExecute('36', username || '').subscribe((res) => {
      this.arrayData = res;
      this.datatable = true;
    });
  }
