...
export class ClasificationViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.uApi.callGetExecute('7', form_clave || '').subscribe((res) => {
  ...
  iniFormGroup() {
    this.displayFormGroup = this._formBuilder.group({
      ...
      checkBox10Ctr: [this.arrayData.checklist_campo_10],
      ...
      riesgoClimaticoResultado: [this.arrayData.nivel_riesgo_climatico],
      riesgoClimatico: [null],
      nivelResultado: [null],
  ...
  checkHighLvlRiskSub(subsector: string) {
    this.uApi.callGetExecute('37', subsector).subscribe((res) => {
      this.lvl4Risk = res[0].high_risk;
      this.calculateRisk();
    });
  }
  ...
  getSubSector(event: any) {
    ...
    this.checkHighLvlRiskSub(this._clasificacion.subsector);
  }
  ...
  turnEdition(option: any) {
    if (option == '1') {
      ...
      this.displayFormGroup.controls['checkBox10Ctr'].disable();
      ...
      this.displayFormGroup.controls['checkBox10Ctr'].enable();
    ...
    if (this.calculoManual == false) {
      if (this.highRiskListChecked == true) {
        ...
        if (
          ...
          } else if (this._clasificacion.sector == 'S') {
            if (totalExpoCustomer >= 100001.0) {
              this.resultado_formula_riesgo = 'ALTO';
            } else {
              this.resultado_formula_riesgo = this.nivelRiesgoDB;
            }
      ...
      if (
        (this.displayFormGroup.controls['riesgoClimatico'].value == 'Alto' ||
          this.displayFormGroup.controls['riesgoClimatico'].value ==
            'MUY ALTO') &&
        this.lvl4Risk == true
      ) {
        this.displayFormGroup.controls['riesgoClimaticoResultado'].setValue(
          'MUY ALTO'
        );
        this.displayFormGroup.controls['riesgoClimatico'].setValue('MUY ALTO');
      } else {
        this.displayFormGroup.controls['riesgoClimatico'].setValue(
          this.riesgoClimatico
        );
      }
  ...
  postUpdateData() {
    let dataArray = {
      ...
      SQLStr:
        ...
        ',' +
        this.displayFormGroup.controls['checkBox10Ctr'].value +
        ',' +
  ...
  openSetClimaticRisk() {
    let dialogRef = this._dialog.open(RiesgoClimaticoComponent, {
      width: '720px',
    });
    ...
    dialogRef.afterClosed().subscribe((result: string) => {
      if (result == undefined || result == 'null') {
        this._snackBar.open(
          'Debe completar el riesgo climático para continuar!...',
          'OK',
          {
            duration: 3000,
          }
        ...
        if (result == 'Alto' && this.lvl4Risk == true) {
          ...
          this.displayFormGroup.controls['riesgoClimatico'].setValue(result);
        }
      }
    });
  }
