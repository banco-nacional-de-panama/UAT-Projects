...
@Component({
  selector: 'app-print-forestal',
  templateUrl: './print-forestal.component.html',
  styleUrls: ['./print-forestal.component.css'],
})
export class PrintForestalComponent implements OnInit {
